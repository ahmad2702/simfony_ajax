...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\LoginForm' => function () {
    return ($this->privates['App\Form\LoginForm'] ?? $this->privates['App\Form\LoginForm'] = new \App\Form\LoginForm());
