...
include_once $this->targetDirs[3].'/src/DataFixtures/LoadUserData.php';
...
$a->addFixtures(array(0 => new \App\DataFixtures\LoadUserData(($this->services['security.password_encoder'] ?? $this->load(__DIR__.'/getSecurity_PasswordEncoderService.php')))));
